...
public class VehiclesApp {
	...
	public static void main(String[] args) {
		...
		//constructor creating delivery van and calling deliver stuff method
		Vehicle van = new DeliveryVan();
		deliverStuffWith(van);

		System.out.println();

		//constructor creating bicycle and calling deliver stuff method
		Vehicle bicycle = new Bicycle();
		deliverStuffWith(bicycle);
	}

	
	//deliver stuff method
